# coding: utf-8
"""Dataset, collation, sampling, and dataloader construction for TTS training."""
...
from tsukasa_speech.data.text import TextCleaner, dicts
from tsukasa_speech.data.mel import SPECT_PARAMS, MEL_PARAMS, preprocess
...
class LengthBucketBatchSampler(Sampler):
    ...
    def __init__(self, data_list, root_path, base_batch_size,
        ...
        # Target tokens = base_batch_size x median length
